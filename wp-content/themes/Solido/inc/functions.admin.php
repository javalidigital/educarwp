<?php
	...
	add_action('after_setup_theme', 'jellythemes_setup');
	function jellythemes_setup(){
	    load_theme_textdomain('jellythemes', get_template_directory() . '/languages');
	}
	...
	if ( function_exists( 'register_nav_menus' ) ) {
		register_nav_menus(
			array(
			  'main' =>  __('Main menu', 'jellythemes')
			)
		);
	}
	// Add custom image sizes
	if ( function_exists( 'add_image_size' ) ) {
	    add_image_size( 'project_image', 1240, 990, true );
	    add_image_size( 'project_featured', 467, 266, true );
	    add_image_size( 'project_thumb', 510, 395, true );
	    add_image_size( 'team_member', 255, 213, true );
	    add_image_size( 'service_icon', 110, 110, true );
	    add_image_size( 'testimonial_avatar', 99, 99, true );
	}
	...
	add_action( 'tgmpa_register', 'jellythemes_register_js_composer_plugins' );
	function jellythemes_register_js_composer_plugins() {
	    /**
